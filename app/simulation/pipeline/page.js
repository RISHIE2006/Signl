...
import { addAnalysisToDB } from "@/lib/api-store";
...
const PIPELINE_ROUNDS = [
  {
    ...
    desc: "5-min culture & background check",
    persona: "The Culture Fit",
    mode: "text",
    timeGoal: 5,
  },
  {
    id: "coding",
    name: "Technical 1",
    desc: "Algorithms & Coding",
    persona: "The Technical Guru",
    mode: "code",
    timeGoal: 15,
  },
  {
  ...
  },
  {
    ...
    desc: "Dual-Persona Panel (Sarah & David)",
    persona: "Dual Panel",
    mode: "text",
    timeGoal: 15,
  },
  {
    ...
    desc: "High-stakes founder interview",
    persona: "The Founder",
    mode: "text",
    timeGoal: 10,
  },
...
export default function PipelinePage() {
  ...
  const startRound = async (index) => {
    ...
    try {
      ...
      newTranscripts[index] = [
        initialMsg,
        { role: "assistant", content: data.content || "Let's begin." },
      ];
      ...
      newTranscripts[index] = [
        ...
        {
          role: "assistant",
          content: "Failed to connect to AI for this round.",
        },
      ];
      setTranscripts(newTranscripts);
    } finally {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      updatedTranscripts[currentRoundIndex] = [
        ...newMessages,
        { role: "assistant", content: data.content || "Could you clarify?" },
      ];
      setTranscripts([...updatedTranscripts]);
    } catch {
      updatedTranscripts[currentRoundIndex] = [
  ...
  const finishPipeline = () => {
    ...
    if (typeof window !== "undefined") {
      const pipelineData = { params, transcripts, rounds: PIPELINE_ROUNDS };
      localStorage.setItem("pipeline_cache", JSON.stringify(pipelineData));
      addAnalysisToDB({ type: "pipeline", ...pipelineData }).catch(() => {});
  ...
  const runCode = () => {
    setConsoleOutput([
      { type: "system", content: "== Executing JavaScript ==" },
    ]);
    ...
    try {
      ...
      setConsoleOutput((prev) => [
        ...prev,
        ...logs.map((l) => ({ type: "log", content: l })),
        { type: "system", content: "== Execution Complete ==" },
      ]);
    } catch (err) {
      setConsoleOutput((prev) => [
        ...prev,
    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        <div
          ...
          style={{
            maxWidth:
              stage === "round" && currentRound?.mode === "code"
                ? "1400px"
                : "900px",
            display: "flex",
          ...
          >
            <div>
              ...
              <p className="page-subtitle">
                Simulate a full 5-stage interview loop back-to-back.
              </p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      You are about to enter a 5-round, multi-persona interview.
                      It is designed to test your endurance, consistency, and
                      ability to pivot between different interview styles (HR,
                      Coding, Design, Panel, Founder). Make sure you have ~60
                      minutes.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid-2" style={{ marginBottom: "24px" }}>
                  <div className="form-group">
                    ...
                    <CompanyAutocomplete
                      ...
                      onChange={(e) =>
                        setParams({ ...params, company: e.target.value })
                      }
                    />
                  </div>
                  <div className="form-group">
            ...
            {stage === "round" && (
              ...
              >
                ...
                >
                  ...
                  >
                    {messages.map((ms, i) => (
                      <motion.div
                        ...
                        style={{
                          alignSelf:
                            ms.role === "user" ? "flex-end" : "flex-start",
                          maxWidth: "85%",
                          display: "flex",
                          flexDirection: "column",
                          alignItems:
                  ...
                  {/* Input */}
                  <div
                    style={{ padding: "20px", borderTop: "var(--border-soft)" }}
                  >
