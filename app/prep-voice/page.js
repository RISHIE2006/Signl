...
export default function VoicePrepPage() {
  ...
  const startSession = async () => {
    ...
    const initialMsg = {
      role: "user",
      content: greetings[config.language] || greetings.English,
    };
    ...
    try {
      ...
      console.error("Failed to start AI session.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="page-container" style={{ maxWidth: "900px" }}>
          <div className="page-header">
            ...
            <p className="page-subtitle">
              Real-time verbal simulations with advanced filler-word and pace
              tracking.
            </p>
          </div>
                ...
                {stage === "parsing" ? (
                  <div style={{ textAlign: "center", padding: "60px 0" }}>
                    ...
                    <p style={{ color: "var(--text-secondary)" }}>
                      Processing resume and preparing TTS engines.
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="grid-2" style={{ marginBottom: "24px" }}>
                      <div className="form-group">
                        ...
                        <textarea
                          ...
                          value={config.jd}
                          onChange={(e) =>
                            setConfig({ ...config, jd: e.target.value })
                          }
                      ...
                      <div className="form-group">
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              See yourself to practice eye contact.
                            </div>
                          </div>
                        </label>
                      </div>
                    ...
                    >
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: "600",
                          opacity:
                            !config.role || !config.company || !canStartPrep
                              ? 0.5
                              : 1,
                        }}
                      >
            ...
            {stage === "active" && (
              ...
              >
                ...
                >
                  ...
                  >
                    {isSpeaking ? (
                      <Volume2 size={48} color="var(--accent)" />
                    ) : isListening ? (
                      <Mic size={48} color="var(--success)" />
                    ) : (
            ...
            {stage === "finished" && (
              ...
              >
                <div style={{ textAlign: "center", marginBottom: "40px" }}>
                  ...
                  <p style={{ color: "var(--text-secondary)" }}>
                    Review your verbal and analytical stats.
                  </p>
                </div>
